...
{
    public abstract class JVServiceOperator
    {
        ...
        protected JVServiceOperator(IResolver resolver, IJVServiceOperationListener listener, IJVLinkService jvLinkSrv)
        {
            _resolver = resolver;
            _listener = listener;
        ...
        public virtual JVLinkServiceOperationResult Operate()
        {
