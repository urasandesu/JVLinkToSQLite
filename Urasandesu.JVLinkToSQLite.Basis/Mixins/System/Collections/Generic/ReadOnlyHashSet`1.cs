...
namespace Urasandesu.JVLinkToSQLite.Basis.Mixins.System.Collections.Generic
{
    public class ReadOnlyHashSet<T> : IEnumerable<T>, IEnumerable, IReadOnlyCollection<T>
    {
